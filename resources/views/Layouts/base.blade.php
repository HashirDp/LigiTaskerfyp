                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto main-nav ">
                                ...
                                <li class="nav-item dropdown dropdown-slide">
                                    <a class="nav-link "  href="{{route('home.service_categories')}}">Categories</a><i class=""></i></span>
                                    </a>
                            ...
                            <a class="dropdown-item" href="{{route('/admin/service_categories')}}">All Service Categories</a>
                            <a class="dropdown-item" href="{{route('/admin/all_services')}}">All Services </a>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-7 offset-md-1 offset-lg-0">
        ...
        <div class="block about">
          ...
          <!-- description -->
          <p class="alt-color">The aim and priority of LigiTasker are to add value to our consumers' lives by providing smart solutions to all their problems. Our pride is providing the most extensive range of services. From home maintenance to personal assistance. We make sure that your safety is never compromised.</p>
        </div>
      </div>
      <!-- Link list -->
      <div class="col-lg-2 offset-lg-1 col-md-3">
        <div class="block">
          ...
          <ul>
            ...
            <li><a href="{{route('home.about_us')}}">Why choose us</a></li>
            <li>03000000000</li>
            <li>ligitasker@gmail.com</li>
      ...
      <div class="col-lg-2 col-md-3 offset-md-1 offset-lg-0">
        <div class="block">
          <h4>Pages</h4>
          <ul>
            <li><a href="{{route('/admin/service_categories')}}">Category</a></li>
            <li><a href="http://127.0.0.1:8000/ac/services">Services</a></li>
      ...
      <div class="col-sm-6 col-12">
        ...
        <div class="copyright">
          <p>Copyright © <script>
            ...
            </script>. All Rights Reserved, <a class="text-primary" href="" target="_blank"></a></p>
        </div>
      </div>
